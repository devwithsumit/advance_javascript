let jokes_array = [`"I just got my doctor's test results and I'm really upset about it. Turns out, I'm not gonna be a doctor"`,
    ...
    `"What’s the special dish in a restaurant for cannibals? Heads, shoulders, knees, and toe"`,
...
function writeJoke(){
    document.querySelector('.joke-box').innerHTML = (jokes_array[Math.floor(Math.random() * 100)]);
}
document.querySelector('button')
.addEventListener('click',writeJoke)
// console.log(jokes_array[Math.floor(Math.random() * 100)]);
// let joke_box = document.querySelector('.joke-box')
